...
res = exec_cmd("mkdir -p /etc/dropbear")
res = exec_cmd("dropbearkey -t ed25519 -f /etc/dropbear/dropbear_ed25519_host_key 0<&- 2>&- >&- || true")
res = exec_cmd("dropbearkey -t ecdsa -f /etc/dropbear/dropbear_ecdsa_host_key 0<&- 2>&- >&- || true")
